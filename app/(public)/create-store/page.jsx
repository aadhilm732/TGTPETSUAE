...
export default function CreateStore() {
        ...
        try {
            ...
            if (['approved', 'rejected', 'pending'].includes(data.status)) {
                ...
                switch (data.status) {
                    ...
                    case "rejected":
                        setMessage("Your store request has been rejected, contact the admin for further details")
                        break;

                    case "pending":
                        setMessage("Your store request is pending, your store results will be notified soon")
                        break;    
    ...
    if (!user) {
        return(
            <div className="min-h-[80hv] mx-6 flex items-center justify-center text-slate-400">
                ...
                <div className="mx-6 min-h-[70vh] my-16">
                    <form onSubmit={e => toast.promise(onSubmitHandler(e), { loading: "Submitting data..." })} className="max-w-7xl mx-auto flex flex-col items-start gap-3 text-slate-500">
                        ...
                        <div>
                            ...
                            <p className="max-w-lg">To become a seller on TGTPETS-UAE, submit your store details for review. Your store will be activated after admin verification.</p>
                        </div>
